...
> {
    return mapSerializer<PriceUpdateV2AccountDataArgs, any, PriceUpdateV2AccountData>(
        ...
        (value) => ({ ...value, discriminator: new Uint8Array([34, 241, 35, 99, 157, 126, 244, 205]) })
    ) as Serializer<PriceUpdateV2AccountDataArgs, PriceUpdateV2AccountData>
}

export function deserializePriceUpdateV2(rawAccount: RpcAccount): PriceUpdateV2 {
    return deserializeAccount(rawAccount, getPriceUpdateV2AccountDataSerializer())
}
...
export async function safeFetchAllPriceUpdateV2(
    ...
    return maybeAccounts
        ...
        .map((maybeAccount) => deserializePriceUpdateV2(maybeAccount as RpcAccount))
}

export function getPriceUpdateV2GpaBuilder(context: Pick<Context, 'rpc' | 'programs'>) {
    ...
    return gpaBuilder(context, programId)
        ...
        .deserializeUsing<PriceUpdateV2>((account) => deserializePriceUpdateV2(account))
