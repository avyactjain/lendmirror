...
export function getVerificationLevelSerializer(): Serializer<VerificationLevelArgs, VerificationLevel> {
    return dataEnum<VerificationLevel>(
        [
            ['Partial', struct<GetDataEnumKindContent<VerificationLevel, 'Partial'>>([['numSignatures', u8()]])],
            ['Full', unit()],
        ],
...
export function verificationLevel(kind: 'Full'): GetDataEnumKind<VerificationLevelArgs, 'Full'>
