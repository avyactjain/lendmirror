...
import { Serializer, bytes, i32, i64, struct, u64 } from '@metaplex-foundation/umi/serializers'
...
export function getPriceFeedMessageSerializer(): Serializer<PriceFeedMessageArgs, PriceFeedMessage> {
